...
<form method="post">
    ...
    <div class="form-group row">
        ...
        <div class="col-12">
            <input type="text" class="form-control" name="titre" id="titre" placeholder="<?= $article->titre ?>" required autofocus>
        </div>
    </div>
    <div class="form-group row">
        <label for="contenu" class="col-12 col-form-label">Contenu de l'article</label>
        <div class="col-12">
            <input type="text" class="form-control" name="contenu" id="contenu" placeholder="<?= $article->contenu ?>" required>
        </div>
    </div>
    <div class="form-group row">
        <label for="image" class="col-12 col-form-label">Image qui représente le contenu</label>
        <div class="col-12">
            <input type="img" class="form-control" name="image" id="image" placeholder="<?= $article->image ?>" required>
        </div>
    </div>
    <div class="form-group row">
        <label for="auteur" class="col-12 col-form-label">Auteur</label>
        <div class="col-12">
            <input type="text" class="form-control" name="auteur" id="auteur" placeholder="<?= $article->auteur ?>" required>
        </div>
    </div>
    <div class="form-group row">
        ...
        <div class="col-12">
            ...
            <span>Date de création : <?= $article->date_de_publication ?></span>
        </div>
    </div>
